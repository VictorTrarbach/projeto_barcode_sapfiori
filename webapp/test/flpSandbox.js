		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#consultaprodutos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"consultaprodutos-display": {
								"semanticObject": "consultaprodutos",
								"action": "display",
								"description": "A Fiori application. Que consulta produtos.",
								"title": "Consulta de Produtos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=consultaprodutos",
									"url": sap.ui.require.toUrl("consultaprodutos")
								}
							}
						}
					}
